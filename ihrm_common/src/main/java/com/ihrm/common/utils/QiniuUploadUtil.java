...
public class QiniuUploadUtil {
    ...
    private static final String accessKey = "ES5x_gs-3mXXW1w3xa5k50356ybOWJmds0Fh7K_7";
    private static final String secretKey = "ap_SWWs5uP_MPDnsIAxqbb8sqb-7QNI-3QQi-3Vy";
    private static final String bucket = "ihrm-bucket";
    private static final String prix = "http://poyrw065k.bkt.clouddn.com/";
